    ...
    for iter in range(args.max_iter_num):
        ...
        while steps < args.total_sample_size: 
            ...
            for _ in range(2000): 
                ...
                action_for_env, action_arr_for_disc = get_action_discrete(action_probs)
                next_state, reward, done, _ = env.step(action_for_env)
                irl_reward = get_reward(discrim, state, action_arr_for_disc)
                ...
                memory.append([state, action_arr_for_disc, irl_reward, mask])
